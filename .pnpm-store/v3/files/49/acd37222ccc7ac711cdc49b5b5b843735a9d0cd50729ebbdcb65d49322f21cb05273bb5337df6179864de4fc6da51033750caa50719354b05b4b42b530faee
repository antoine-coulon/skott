 ...
 * @since 1.0.0
 */
export declare const getEquivalence: <T extends ReadonlyArray<equivalence.Equivalence<any>>>(...predicates: T) => equivalence.Equivalence<Readonly<{
 ...
 * @since 1.0.0
 */
export declare const getSemigroup: <T extends readonly semigroup.Semigroup<any>[]>(...elements: T) => semigroup.Semigroup<{ readonly [I in keyof T]: [T[I]] extends [semigroup.Semigroup<infer A>] ? A : never; }>;
/**
 ...
 * @since 1.0.0
 */
export declare const getMonoid: <T extends readonly monoid.Monoid<any>[]>(...elements: T) => monoid.Monoid<{ readonly [I in keyof T]: [T[I]] extends [monoid.Monoid<infer A>] ? A : never; }>;
/**
